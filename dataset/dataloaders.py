...
def create_image_text_dataloaders(dataset,
    ...
    # to make it infinite 
    loader = IterLoader(dataloader_iterator,
...
def create_mixed_datalaoders(dataset,
                             batch_size,
                             num_workers,
                             world_size=None,
                             rank=None,
    ...
    """ The video and image mixed training dataloader builder"""
    ...
    print(f"{image_gpus} gpus for image, \
          {video_gpus} gpus for video")

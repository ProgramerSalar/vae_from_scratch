...
LPIPS_CKPT=vae_from_scratch/flow/video_vae/vgg_lpips.pth   # The LPIPS VGG CKPT path, used for calculating the lpips loss
...
VAE_CKPT_PATH=flow/PATH/pyramid-flow-miniflux/causal_video_vae/diffusion_pytorch_model.safetensors  # The stage-1 trained ckpt
